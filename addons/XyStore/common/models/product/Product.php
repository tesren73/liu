...
use addons\XyStore\common\enums\CommonTypeEnum;
use addons\XyStore\common\enums\OrderStatusEnum;
use addons\XyStore\common\models\common\Collect;
use addons\XyStore\common\models\order\OrderProduct;

/**
 * This is the model class for table "{{%addon_store_product}}".
 *
 * @property string $id
...
class Product extends \common\models\base\BaseModel
{
    ...
    {
        return [
            [['name', 'cate_id', 'price', 'stock', 'warning_stock'], 'required'],
            [
                [
                    'supplier_id',
                    'integral_give_type',
            ...
            [['posters', 'is_package', 'is_attribute'], 'string'],
            [
                [
                    'price',
                    'market_price',
