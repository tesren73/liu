...
use addons\XyStore\common\enums\PreferentialTypeEnum;

/**
 * This is the model class for table "{{%addon_store_product_ladder_preferential}}".
 *
 * @property int $id 主键
...
class LadderPreferential extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%addon_store_product_ladder_preferential}}';
    }
