...
/**
 * This is the model class for table "{{%addon_store_product_brand}}".
 *
 * @property string $id
...
class Brand extends \common\models\base\BaseModel
{
    ...
    {
        return '{{%addon_store_product_brand}}';
    }
    ...
    {
        if (Yii::$app->xyStoreService->productBrand->findByTitle($this->title)) {
