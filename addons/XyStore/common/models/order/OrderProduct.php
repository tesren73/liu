...
use addons\XyStore\common\models\product\Evaluate;
use addons\XyStore\common\models\product\Product;
use addons\XyStore\common\models\product\Sku;
...
/**
 * This is the model class for table "{{%addon_store_order_product}}".
 *
...
class OrderProduct extends BaseModel
{
    ...
    {
        return '{{%addon_store_order_product}}';
    }
