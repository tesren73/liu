...
use addons\XyStore\common\enums\RefundTypeEnum;
...
class ProductService extends Service
{
    ...
    public function refundReturnMoney($id)
    {
        ...
        // 自动更新订单状态
        Yii::$app->xyStoreService->order->autoUpdateStatus($model['order_id']);
    ...
    public function deliver($ids, $order_id)
    {
        ...
        // 自动更新订单状态
        Yii::$app->xyStoreService->order->autoUpdateStatus($order_id);
    }
