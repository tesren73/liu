...
use addons\XyStore\common\enums\VirtualProductGroupEnum;
...
class ProductController extends BaseController
{
    ...
    public function actionEdit()
    {
        ...
        return $this->render($this->action->id, [
            ...
            'tags' => Yii::$app->xyStoreService->productTag->getMapByList($model->tags),
    ...
    {
        // 属性值
        $data = Yii::$app->xyStoreService->baseAttribute->getDataById($base_attribute_id);
        $value = $data['value'] ?? [];
        ...
        $spec_ids = $spec_ids ?? [];
        $spec = Yii::$app->xyStoreService->baseSpec->getListWithValueByIds($spec_ids);
