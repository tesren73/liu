...
namespace addons\XyStore\merchant\modules\base\controllers;

use Yii;
use common\enums\StatusEnum;
use common\models\base\SearchModel;
use common\traits\MerchantCurd;
use addons\XyStore\common\models\base\Attribute;
use addons\XyStore\common\models\base\AttributeValue;
...
class AttributeController extends BaseController
{
    ...
    public function actionEdit()
    {
        ...
        return $this->render($this->action->id, [
            'model' => $model,
            'specs' => Yii::$app->xyStoreService->baseSpec->getMapList(),
